    ...
    <>
      ...
      <div className={classes.countdown}>
        <div>
          ...
          <p className={classes.clock_label}>{/* <small>দিন</small> */}</p>
        </div>
        <div>
          <p className={classes.single_clock}>00</p>
          {/* <p className={classes.single_clock}>{hours}</p> */}
          <p className={classes.clock_label}>{/* <small>ঘণ্টা</small> */}</p>
        </div>
        <div>
          <p className={classes.single_clock}>00</p>
          {/* <p className={classes.single_clock}>{minutes}</p> */}
          <p className={classes.clock_label}>{/* <small>মিনিট</small> */}</p>
        </div>
        <div>
          <p className={classes.single_clock}>00</p>
          {/* <p className={classes.single_clock}>{seconds}</p> */}
          <p className={classes.clock_label}>{/* <small>সেকেন্ড</small> */}</p>
        </div>
